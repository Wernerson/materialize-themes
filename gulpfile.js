...
gulp.task('sass:expanded', gulp.series('copy', function () {
...
gulp.task('sass:min', gulp.series('sass:expanded', function () {
    var themes = primaryColors.map(primaryColor => {
        return secondaryColors.map(secondaryColor => {
...
gulp.task('default', gulp.series('clean', 'copy', 'sass:expanded', 'sass:min'));
